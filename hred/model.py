...
class Hred:
    ...
    def __init__(self, vocab_size, embedding_maxtrix, training_mode, iterNumber,n_hidden=128, n_layers=3):

        self.learning_late = 0.001
        self.vocab_size = vocab_size
        self.embedding_size = 300
        self.init_width = 1 / self.embedding_size
        self.word_embedding_matrix = embedding_maxtrix
    ...
    def build_ops(self, outputs, targets):
        ...
        with tf.variable_scope('ops', reuse=tf.AUTO_REUSE):
            for i in range(self.iterNumber):
                ...
                f = tf.fill([9, tf.subtract(25, self.dec_max_length[i]), 91667], 0.0)
